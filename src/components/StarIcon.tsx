...
export const StarIcon = ({ className = "w-12 h-12" }: StarIconProps) => {
    return (
        <svg
        ...
        >
            <defs>
                ...
                <linearGradient id="starGradientIcon" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <g fill="#FCD34D" filter="url(#goldGlowIcon)">
                {/* Particle 1 */}
            ...
            <polygon points="0,-20 6,-7 20,-7 9,2 13,16 0,8 -13,16 -9,2 -20,-7 -6,-7" fill="url(#starGradientIcon)" stroke="#F59E0B" strokeWidth="1">
                {/* Subtle Pulse */}
            ...
            <circle r="3" fill="#FFFFFF" opacity="0.9" filter="url(#goldGlowIcon)">
